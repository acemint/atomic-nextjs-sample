export default function LoremIpsum() {
  return (
    <main>
      <h1>h1: Welcome to Imagination Company</h1>
      ...
      <ol>
        ...
        <li>li: Step 2: Write your imagination</li>
        <li>li: Step 3: Explore the progress of your imagination</li>
      </ol>
      <button>button: Start Free Trial</button>
    </main>
  );
}
